...
YUI({
    ...
    suite.add(new Y.Test.Case({
        "test YUI Dashboard": function () {
            ...
            //YUI/Mojito Developer Dashboard/

            // Tests the title within the content
            Y.Assert.areEqual("Trib - YUI/Mojito Developer Dashboard", Y.one('body h1').get('innerHTML'));
            /*
             *  Expected: Trib - YUI Developer Dashboard (string)
             *   Actual: Trib - YUI/Mojito Developer Dashboard (string)
             *   */
        }
    }));
